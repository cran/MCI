...
submarkets_single <- levels(mciworkfile[[submarkets]])   
suppliers_single <- levels(mciworkfile[[suppliers]])   
submarkets_count <- nlevels(mciworkfile[[submarkets]])   
suppliers_count <- nlevels(mciworkfile[[suppliers]])   
submarket_i_geom <- 0   
submarket_i_rel <- 0   
